...
namespace System
{
    public static partial class Math
    {
        ...
        public static unsafe double Round(double value, int digits, MidpointRounding mode)
        {
            ...
            {
                throw new ArgumentException($"The value '{mode}' is not valid for this usage of the type {nameof(MidpointRounding)}.", nameof(mode));
            }
                ...
                switch (mode)
                {
                    ...
                    default:
                    {
                        throw new ArgumentException(
                            $"The value '{mode}' is not valid for this usage of the type {nameof(MidpointRounding)}.",
                            nameof(mode));
                    }
                }
        ...
        public static int Sign(double value)
        {
            ...
            throw new ArithmeticException(ArithmeticException.NaN);
        }
        ...
        {
            const double toint = 1 / double.Epsilon;
            
            var i = BitConverter.DoubleToUInt64Bits(x);
            var e = (int)(i >> 52 & 0x7ff);
            double y;
